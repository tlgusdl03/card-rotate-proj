...
public class BoardServiceTest {
    ...
    User user = new User(1L, "test001", "test001@gmail.com", "test001");
    ...
    void post(){
        //given
        Board board = new Board(1L, new Date(), user, "testBoard001", "It`s first test board");
    ...
    void edit(){
        //given
        Board board = new Board(1L, new Date(), user, "testBoard001", "It`s first test board");
        Board newBoard = new Board(1L, new Date(), user, "testBoard001", "It`s changed test board");
